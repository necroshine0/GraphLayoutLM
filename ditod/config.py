...
def add_vit_config(cfg):
    ...
    _C.PUBLAYNET_DATA_DIR_TRAIN = "/path/to/data/PubLayNet/publaynet/train"
    _C.PUBLAYNET_DATA_DIR_TEST = "/path/to/data/PubLayNet/publaynet/val"

    _C.ICDAR_DATA_DIR_TRAIN = ""
    _C.ICDAR_DATA_DIR_TEST = ""

    _C.SBERSLIDES_DATA_DIR_TRAIN = ""
    _C.SBERSLIDES_DATA_DIR_TEST = ""
